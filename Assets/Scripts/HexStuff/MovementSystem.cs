...
public class MovementSystem : MonoBehaviour
{
    ...
    public void ShowRange(Piece selectedUnit, HexGrid hexGrid)
    {
    ...
    public void CalcualteRange(Piece selectedUnit, HexGrid hexGrid)
    {
    ...
    public void MoveUnit(Piece selectedUnit, HexGrid hexGrid)
    {
